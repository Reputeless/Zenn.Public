...
リニアモーターカーを提案する人は、類似するものとして新幹線を挙げるだけでは不十分です。領域を「交通」と広げると、「高速に走行」という目的で作られているものには高速道路や飛行機もあります。あなたの提案に類似するものが 1 つしか見つからない場合は、領域を少し広げて考えましょう。

「同じような目的で作られたもの」を複数挙げることができたら、提案書では、自身の提案をそれらと比較して、**違い**や、**利点と欠点**、**自身の提案にも応用できる要素**を考察し、詳しく説明します。
